_base_ = [
    '../_base_/models/carb.py', '../_base_/datasets/wilddash2_w.py', 
...
model = dict(
    ...
    decode_head=dict(
        num_classes=25,                         # number of classes
        text_categories=25,                     # number of classes
        text_embeddings_path='pretrain/wilddash2_ViT16_clip_text.pth',

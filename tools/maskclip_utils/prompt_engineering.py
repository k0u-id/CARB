...
cityscape_carb_classes = ['road', 'sidewalk', 'building', 'wall', 'fence',
                        'pole', 'traffic light',  'traffic sign', 'tree', 'grass',
                        'sky', 'pedestrian', 'rider', 'car', 'truck',
                        'bus', 'train', 'motorcycle', 'bicycle']

wilddash2_classes = ['ego vehicle', 'road', 'sidewalk', 'building', 'wall', 'fence', 'guard rail',
...
def parse_args():
    ...
    parser.add_argument('--class-set', default=['city_carb'], nargs='+',
        choices=['camvid', 'city_carb', 'wilddash2', 'city', 'ade', 'stuff', 'voc', 'context', 'acontext', 'mickey', 'batman', 'mario', 'gates', 'blur', 'sports', 'car_brands', 'batman_ext', 'car_color'],
...
if __name__ == '__main__':
    ...
    classes = []
    all_set_name = ''
    name_mapping = {'city': cityscapes_classes, 
                    'ade': ade20k_classes, 
                    'stuff': coco_stuff_classes, 
                    'voc': voc_classes, 
                    'context': pascal_context_classes, 
                    'acontext': all_pascal_context_classes, 
                    'mickey': mickey_classes, 
                    'batman': batman_classes, 
                    'mario': mario_classes, 
                    'gates': gates_classes, 
                    'blur': blur_classes, 
                    'sports': sports_classes, 
                    'car_brands': car_brands_classes, 
                    'batman_ext': batman_ext_classes, 
                    'car_color': car_color_classes,
                    'city_carb': cityscape_carb_classes,
                    'camvid': camvid_classes,
                    'wilddash2': wilddash2_classes}
